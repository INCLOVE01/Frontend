            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-0 md:p-8">
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Button variant="outline" type="button" className="w-full hover:bg-neutral-200">
                  ...
                  <Button variant="outline" type="button" className="w-full hover:bg-[#4285F4]/30">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path
                ...
                <div className="text-center text-sm">
                  ...
                  <Link href={'/auth/sign-up'} className="underline underline-offset-4 text-indigo-400">Sign-up</Link>
                </div>
              </div>
            </form>
          </Form>
