...
export default function MainNavbar(){
    ...
    return(
        <>
            <nav className="w-full max-w-sm h-fit flex items-center justify-evenly gap-2 fixed top-2 left-1/2 -translate-x-1/2 z-[100] p-2 bg-white/30 backdrop-blur-2xl rounded-md outline ">
